...
def split_cycle_segment(par, tiempo_final, tiempo_final_dict, flujos, sc_lat, sc_geo):
    ...
    seg2 = build(max_idx, len(flux), reverse=False)
    # Invertir sólo flujo y coordenadas en seg2, manteniendo el tiempo en orden normal
    seg2['flux'] = seg2['flux'][::-1]
    seg2['coords_aacgm'] = seg2['coords_aacgm'][::-1]
    seg2['coords_geo'] = seg2['coords_geo'][::-1]
